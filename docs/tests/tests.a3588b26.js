...
})({"kflZJ":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "7fdecc98a3588b26";
"use strict";
...
},{}],"fVIJ0":[function(require,module,exports,__globalThis) {
var _indexJs = require("./index.js");
globalThis.expect = (0, _indexJs.expect);

},{"./index.js":"dywVz"}],"dywVz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Assertion", ()=>Assertion);
parcelHelpers.export(exports, "AssertionError", ()=>AssertionError);
parcelHelpers.export(exports, "Should", ()=>Should);
parcelHelpers.export(exports, "assert", ()=>assert);
parcelHelpers.export(exports, "config", ()=>config);
parcelHelpers.export(exports, "expect", ()=>expect);
parcelHelpers.export(exports, "should", ()=>should);
parcelHelpers.export(exports, "use", ()=>use);
parcelHelpers.export(exports, "util", ()=>utils_exports);
var Buffer = require("66dfb149ef8e6875").Buffer;
...
truncate: truncate2 = Infinity, stylize = String } = {}, inspect3) {
    const options = {
...
function simpleEqual(leftHandOperand, rightHandOperand) {
    ...
    rightHandOperand !== rightHandOperand) return true;
...
var _Assertion = class _Assertion {
   ...
   */ constructor(obj, msg, ssfi, lockSsfi){
        /** @type {{}} */ __publicField(this, "__flags", {});
    ...
    /** @returns {boolean} */ static get includeStack() {
        console.warn("Assertion.includeStack is deprecated, use chai.config.includeStack instead.");
        return config.includeStack;
    }
    /** @param {boolean} value */ static set includeStack(value) {
        console.warn("Assertion.includeStack is deprecated, use chai.config.includeStack instead.");
        config.includeStack = value;
    }
    /** @returns {boolean} */ static get showDiff() {
        console.warn("Assertion.showDiff is deprecated, use chai.config.showDiff instead.");
        return config.showDiff;
    }
    /** @param {boolean} value */ static set showDiff(value) {
        console.warn("Assertion.showDiff is deprecated, use chai.config.showDiff instead.");
   ...
   */ assert(_expr, msg, _negateMsg, expected, _actual, showDiff) {
        ...
        if (!ok) {
            ...
            throw new AssertionError(msg, assertionErrorObjectProperties, // @ts-expect-error Not sure what to do about these types yet
        ...
        get: /* @__PURE__ */ __name(function proxyGetter(target, property) {
            if (typeof property === "string" && config.proxyExcludedKeys.indexOf(property) === -1 && !Reflect.has(target, property)) {
                ...
                getProperties(target).forEach(function(prop) {
                    if (// we actually mean to check `Object.prototype` here
...
function getOperator(obj, args) {
    ...
    if (/\shave\s/.test(msg)) return void 0;
...
},{"66dfb149ef8e6875":"4061N","@parcel/transformer-js/src/esmodule-helpers.js":"fVvIk"}]},["kflZJ","fVIJ0"], "fVIJ0", "parcelRequiref658", {})

//# sourceMappingURL=tests.a3588b26.js.map
